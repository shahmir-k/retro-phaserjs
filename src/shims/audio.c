...
void register_audio_shim(JSCContext *ctx) {
    ...
    jsc_context_evaluate(ctx,
        ...
        "    return { frequency: { value: 440, setValueAtTime: function(){} }, type: 'sine',"
        "      connect: function(){ return this; }, disconnect: function(){}, start: function(){}, stop: function(){},"
        ...
        "    return { pan: { value: 0, setValueAtTime: function(){}, linearRampToValueAtTime: function(){} },"
        "      connect: function(){ return this; }, disconnect: function(){} };"
        "  };"
        "  this.createBiquadFilter = function() {"
        "    return { type: 'lowpass', frequency: { value: 350, setValueAtTime: function(){} },"
        "      Q: { value: 1 }, gain: { value: 0 },"
        "      connect: function(){ return this; }, disconnect: function(){} };"
        "  };"
        "  this.createAnalyser = function() {"
        "    return { fftSize: 2048, frequencyBinCount: 1024,"
        "      getByteFrequencyData: function(a){}, getByteTimeDomainData: function(a){},"
        "      getFloatFrequencyData: function(a){}, getFloatTimeDomainData: function(a){},"
        "      connect: function(){ return this; }, disconnect: function(){} };"
        "  };"
        "  this.createConvolver = function() {"
        "    return { buffer: null, normalize: true,"
        "      connect: function(){ return this; }, disconnect: function(){} };"
        "  };"
        "  this.createDelay = function(maxTime) {"
        "    return { delayTime: { value: 0, setValueAtTime: function(){}, linearRampToValueAtTime: function(){} },"
        "      connect: function(){ return this; }, disconnect: function(){} };"
        "  };"
        ...
        "      connect: function(){ return this; }, disconnect: function(){} };"
        "  };"
        "  this.createBuffer = function(numChannels, length, sampleRate) {"
        "    var ch = [];"
        "    for (var i = 0; i < numChannels; i++) ch.push(new Float32Array(length));"
        "    return { duration: length / sampleRate, length: length,"
        "      numberOfChannels: numChannels, sampleRate: sampleRate,"
        "      getChannelData: function(c) { return ch[c] || ch[0]; },"
